import { MessageSquare, Terminal, Folder, GitBranch, ClipboardCheck, FileText, type LucideIcon } from 'lucide-react';
...
const BASE_TABS: BuiltInTab[] = [
  ...
  { kind: 'builtin', id: 'prd',   labelKey: 'tabs.prd',   icon: FileText },
];
